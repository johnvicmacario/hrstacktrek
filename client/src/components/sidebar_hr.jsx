...
const Sidebar = () => {
  ...
  return (
    <div className="side bg-orange-500  text-white w-52 ">
      <ul className="ul">
        <a href="/dashboard">
          <div className="image p-3 cursor:pointer ">
        ...
        <a href="/dashboard">
          <li className="py-3 mt-2 px-2 flex items-center text-center hover:bg-orange-600 hover:rounded-tl-lg hover:rounded-bl-lg">
            ...
            <p className="block font-semibold text-lg pl-7">Dashboard</p>
          </li>
        </a>
        <a href="/jobroles">
          <li className="py-3 mt-2  px-2  flex items-center text-center hover:bg-orange-600 hover:rounded-tl-lg hover:rounded-bl-lg">
            ...
            <p className="block font-semibold text-lg pl-7"> Position </p>
          </li>
        </a>
        <a href="/employee">
          <li className="py-3 mt-2 px-2  flex items-center text-center hover:bg-orange-600 hover:rounded-tl-lg hover:rounded-bl-lg">
            ...
            <p className="block font-semibold text-lg pl-7"> Employee </p>
          </li>
        </a>

        <a href="/attendance_hr">
          <li className="py-3 mt-2  px-2  flex items-center text-center hover:bg-orange-600 hover:rounded-tl-lg hover:rounded-bl-lg">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            ...
            <p className="block font-semibold text-lg pl-7"> Attendance </p>
          </li>
        </a>
        ...
        <a href="/payroll">
          <li className="py-3 mt-2 px-2 flex items-center text-center hover:bg-orange-600 hover:rounded-tl-lg hover:rounded-bl-lg">
            ...
            <p className="block font-semibold text-lg pl-7"> Payrolls</p>
          </li>
        </a>
        <a href="/salaries">
          <li className="py-3 mt-2  px-2  flex items-center text-center hover:bg-orange-600 hover:rounded-tl-lg hover:rounded-bl-lg">
            ...
            <p className="block font-semibold text-lg pl-7"> Salaries </p>
          </li>
        </a>
        {/* <a href="/deduction">
        ...
        <a href="# ">
          <li
            ...
            <p className="block font-semibold text-lg pl-7"> Deduction </p>
          </li>
        </a>
        <a href="/expense">
          <li className="py-3 mt-2  px-2  flex items-center text-center hover:bg-orange-600 hover:rounded-tl-lg hover:rounded-bl-lg">
            ...
            <p className="block font-semibold text-lg pl-7"> Expense </p>
          </li>
        </a>
